...
import com.javanauta.usuario.infrastructure.exception.dto.ErrorResponseDTO;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    // AJUSTE AQUI: Adicionado o 'static' para permitir o uso correto dentro do filtro
    ...
    private String buildError(int status, String mensagem, String path, String error) {
        ...
        try {
            ...
            // Lançando a exceção dedicada estática interna
            throw new JsonConversionException("Erro ao converter o DTO de erro para JSON", e);
        }
    }
}